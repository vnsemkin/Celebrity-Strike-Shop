...
public class GameItemService {
    ...
    public Result<GameItemRespDto> updateGameItem(@NonNull Long id, @NonNull GameItemUpdateReqDto dto) {
        try {
            GameItemEntity gameItem = gameItemRepository.findById(id)
                .orElseThrow(() -> new GameItemNotFoundException("Game item with id " + id + " not found"));
