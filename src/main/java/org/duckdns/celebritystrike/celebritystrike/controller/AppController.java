...
import org.duckdns.celebritystrike.celebritystrike.dto.req.*;
...
public class AppController {
  ...
  public Result<String> saveGames(@RequestBody GameReqDto gameReqDto) {
    ...
    if (gameReqDto == null) {
      ...
      return Result.<String>builder()
          .success(false)
          .data(null)
          .message("Post req received: null")
          .build();
    }
  ...
  public Result<GameRespDto> updateGame(
      @PathVariable String name, @RequestBody GameUpdateReqDto gameUpdateReqDto) {
  ...
  public Result<ImageRespDto> updateImage(
      @PathVariable Long id, @RequestBody ImageUpdateReqDto imageUpdateReqDto) {
  ...
  public Result<GameItemRespDto> createGameItem(
      @RequestBody GameItemCreateReqDto gameItemCreateReqDto) {
  ...
  public Result<GameItemRespDto> updateGameItem(
      @PathVariable Long id, @RequestBody GameItemUpdateReqDto gameItemUpdateReqDto) {
  ...
  @PostMapping("/chat/send-message/{id}")
  public Result<String> sendMessage(
      @PathVariable long id, @RequestBody MessageToChatReq messageToChatReq) {
    log.info(
        "Post request data: method sendMessage: chatId={}, message={}",
        id,
        messageToChatReq.message());
    return handler.send(id, messageToChatReq);
  }
}
